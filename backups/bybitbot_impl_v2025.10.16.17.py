# -*- coding: utf-8 -*-
BOT_VERSION = "0.0.0.0"
__doc__ = "Bybit Intraday AI Trading Bot (30m, 5 pair USDT perpetual)\nVersion: {version}\nPowered by OpenAI GPT and Telegram integration."
...
def apply_metadata(version: str, changelog: str) -> None:
    """Update module metadata so loader defines the active version."""
    global BOT_VERSION, CHANGELOG_TEXT, __doc__
    BOT_VERSION = version
...
def main():
    ...
    log(f"Changelog: {CHANGELOG_TEXT}", Fore.MAGENTA)
    ...
    send_tg(f"ℹ️ Версия {BOT_VERSION}. {CHANGELOG_TEXT}")
